...
class UpdateBase(
    ...
    def returning(self, *cols):
        ...
        .. sourcecode:: pycon+sql
            ...
            ...     (table.c.last_name + " " + table.c.last_name).label("fullname")
            ... )
            >>> print(stmt)
            INSERT INTO some_table (last_name, last_name)
            VALUES (:last_name, :last_name)
            RETURNING some_table.last_name || :last_name_1 || some_table.last_name AS fullname
